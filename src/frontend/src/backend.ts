...
import type { Profile as _Profile, UserRole as _UserRole, UserRole__1 as _UserRole__1 } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createRoom(arg0: string, arg1: string): Promise<RoomId> {
        if (this.processError) {
            try {
    ...
    async getMessages(arg0: RoomId): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async getNote(arg0: RoomId): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getRoomParticipants(arg0: RoomId): Promise<Array<[Principal, Profile]>> {
        if (this.processError) {
            try {
    ...
    async joinRoom(arg0: RoomCode): Promise<void> {
        if (this.processError) {
            try {
    ...
    async saveCallerUserProfile(arg0: Profile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCallerUserProfile(to_candid_Profile_n12(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveNote(arg0: RoomId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: RoomId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_tuple_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, _Profile]): [Principal, Profile] {
    return [
        value[0],
        from_candid_Profile_n4(_uploadFile, _downloadFile, value[1])
    ];
}
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "client" in value ? UserRole.client : "admin" in value ? UserRole.admin : "consultant" in value ? UserRole.consultant : "engineer" in value ? UserRole.engineer : "analyst" in value ? UserRole.analyst : value;
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, _Profile]>): Array<[Principal, Profile]> {
    return value.map((x)=>from_candid_tuple_n11(_uploadFile, _downloadFile, x));
}
function to_candid_Profile_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Profile): _Profile {
